    ...
    <div class="navbar-right">
      ...
      <div id="id01" class="login">
        <form action="includes/login_inc.php" method="POST" class="login-content animate">
          ...
          <div class="container">
            <button class="twelve columns button-primary" type="submit" name="submit">Login</button>
            <button class="twelve columns" type="button" onclick="document.getElementById('id01').style.display='none'" class="button">Cancel</button>
          </div>
        </form>
      </div>
